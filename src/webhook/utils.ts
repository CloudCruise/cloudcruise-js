...
import { VerificationError, type WebhookVerificationOptions } from './types.js';
...
export function verifyMessage<E extends EventType = EventType>(
  receivedData: any,
  receivedSignature: string,
  secretKey: string,
